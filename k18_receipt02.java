...
public class k18_receipt02 {
	...
	public static void main(String[] args) {
		...
		// #6. 날짜 & 시간 인쇄하기 -> Calendar & SimpleDateFormat 사용
		// (1) 현재 날짜 & 시간 인쇄하기 -> Calendar형 객체 선언 및 인스턴스화.
		Calendar k18_cal = Calendar.getInstance();
		// (2) 환불 가능 일자 구하기 (구입일 + 14일)
		// -> Calendar형 객체 선언 및 인스턴스화 후, Calendar 클래스에 포함된 add, DATE 함수 사용!
		Calendar k18_cal2 = Calendar.getInstance();
		k18_cal2.add(Calendar.DATE, 14);
		
		// SimpleDateFormat 형 객체 선언 및 형식 초기화
		// (1) 계산 날짜,시간 인쇄용 ("연연연연.월월.일일 시시:분분:초초")
		SimpleDateFormat k18_sdf = new SimpleDateFormat ("YYYY.MM.dd HH:mm:ss");
		// (2) 교환,환불 가능 일자 인쇄용 ("MM월dd일")
		...
		System.out.printf("================================================\n"); // 특수문자 : 48개
		System.out.printf("%19s%4s%3s\n","교환/환불 14일(",k18_sdf2.format(k18_cal2.getTime()),")이내,");
